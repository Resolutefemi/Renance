...
var examBankTechDrawing = []SeedExamQuestion{
	...
	{SubjectCode: "TDR", Band: "senior", Term: 3,
		Question:    "In building drawings, the plan view is taken looking:",
		Options:     [4]string{"From above", "From the side", "From below", "From an angle"},
		AnswerIndex: 0,
		Explanation: "Plans cut horizontally and look down on the layout."},
	{SubjectCode: "TDR", Band: "senior", Term: 3,
		Question:    "Dimensions on a working drawing are written in:",
		Options:     [4]string{"Millimetres by convention", "Any unit mixed", "Kilometres", "Pounds"},
		AnswerIndex: 0,
		Explanation: "Metric working drawings use millimetres without unit marks."},
	{SubjectCode: "TDR", Band: "senior", Term: 3,
		Question:    "A development drawing unfolds a solid into:",
		Options:     [4]string{"A flat pattern", "A perspective", "A freehand sketch", "A model"},
		AnswerIndex: 0,
