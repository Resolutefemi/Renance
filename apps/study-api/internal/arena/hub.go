...
// string means "any body" and gets its own bucket. POST-UTME is its own
// arena: a JAMBite, a WASSCE candidate and a tertiary student never
// share a queue, a pack shelf or a leaderboard.
